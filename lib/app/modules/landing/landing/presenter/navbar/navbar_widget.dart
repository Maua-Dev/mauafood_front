      ...
      child: Padding(
        ...
        child: Observer(builder: (_) {
          return Row( 
                ...
                children: [
                controller.index == 0 ? Container(height: 50, width: 125, decoration: BoxDecoration(color: AppColors.backgroundColor2, borderRadius: BorderRadius.circular(12)), child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children:[Icon(FontAwesomeIcons.house, color: AppColors.mainBlueColor, size: 26), Text("Home", style: TextStyle(color: AppColors.mainBlueColor, fontSize: 16, fontWeight: FontWeight.bold),)],),
                      ...
                      }, padding: const EdgeInsets.all(0), icon: Icon(FontAwesomeIcons.house, color: AppColors.backgroundColor2, size: 26,)),
                controller.index == 1 ? Container(height: 50, width: 125, decoration: BoxDecoration(color: AppColors.backgroundColor2, borderRadius: BorderRadius.circular(12)), child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children:[Icon(FontAwesomeIcons.cartPlus, color: AppColors.mainBlueColor, size: 26), Text("Cesta", style: TextStyle(color: AppColors.mainBlueColor, fontSize: 16, fontWeight: FontWeight.bold),)],),
                      ...
                      }, padding: const EdgeInsets.all(0), icon: Icon(FontAwesomeIcons.cartPlus, color: AppColors.backgroundColor2, size: 26)),
                controller.index == 2 ? Container(height: 50, width: 125, decoration: BoxDecoration(color: AppColors.backgroundColor2, borderRadius: BorderRadius.circular(12)), child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children:[Icon(Icons.person_outline_outlined, color: AppColors.mainBlueColor, size: 40), Text("Perfil", style: TextStyle(color: AppColors.mainBlueColor, fontSize: 16, fontWeight: FontWeight.bold),)],),
                      ...
                      }, padding: const EdgeInsets.all(0), icon: Icon(Icons.person_outline_outlined,color: AppColors.backgroundColor2, size: 40,)),
                controller.index == 3 ? Container(height: 50, width: 125, decoration: BoxDecoration(color: AppColors.backgroundColor2, borderRadius: BorderRadius.circular(12)), child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 16.0),
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children:[Icon(FontAwesomeIcons.circleQuestion, color: AppColors.mainBlueColor, size: 30), Text("Ajuda", style: TextStyle(color: AppColors.mainBlueColor, fontSize: 16, fontWeight: FontWeight.bold),)],),
                      ...
                      }, padding: const EdgeInsets.all(0), icon: Icon(FontAwesomeIcons.circleQuestion, color: AppColors.backgroundColor2, size: 30))],);
        }),
      ),
    );
  }
