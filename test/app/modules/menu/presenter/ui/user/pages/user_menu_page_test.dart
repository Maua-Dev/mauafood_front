...
void main() {
  ...
  testWidgets(
      '[WIDGETS TEST] - RestaurantsPage must show widgets when initialize',
      (widgetTester) async {
  ...
  testWidgets('[WIDGETS TEST] - RestaurantsPage must show widgets when Success',
      (widgetTester) async {
    await mockNetworkImagesFor(() async {
      await widgetTester
          .runAsync(() async => await widgetTester.pumpWidget(MaterialApp(
  ...
  testWidgets('[WIDGETS TEST] - RestaurantsPage must show widgets when Loading',
      (widgetTester) async {
    await mockNetworkImagesFor(() async {
      await widgetTester
          .runAsync(() async => await widgetTester.pumpWidget(MaterialApp(
  ...
  testWidgets('[WIDGETS TEST] - RestaurantsPage must show widgets when Error',
      (widgetTester) async {
    await mockNetworkImagesFor(() async {
      await widgetTester
          .runAsync(() async => await widgetTester.pumpWidget(MaterialApp(
