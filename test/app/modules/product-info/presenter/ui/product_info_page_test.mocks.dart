...
class _FakeOrderStatusController_3 extends _i1.SmartFake
    implements _i5.OrderStatusController {
  _FakeOrderStatusController_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakeCartState_4 extends _i1.SmartFake implements _i6.CartState {
  _FakeCartState_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockProductInfoController extends _i1.Mock
    implements _i7.ProductInfoController {
  ...
  @override
  _i8.RestaurantEnum get restaurant => (super.noSuchMethod(
        Invocation.getter(#restaurant),
        returnValue: _i8.RestaurantEnum.none,
      ) as _i8.RestaurantEnum);
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCartController extends _i1.Mock implements _i9.CartController {
  MockCartController() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.OrderStatusController get orderController => (super.noSuchMethod(
        Invocation.getter(#orderController),
        returnValue: _FakeOrderStatusController_3(
          this,
          Invocation.getter(#orderController),
        ),
      ) as _i5.OrderStatusController);
  ...
  @override
  _i8.RestaurantEnum get restaurantCart => (super.noSuchMethod(
        Invocation.getter(#restaurantCart),
        returnValue: _i8.RestaurantEnum.none,
      ) as _i8.RestaurantEnum);

  @override
  set restaurantCart(_i8.RestaurantEnum? value) => super.noSuchMethod(
        Invocation.setter(
          #restaurantCart,
          value,
        ),
  ...
  @override
  set state(_i6.CartState? value) => super.noSuchMethod(
        Invocation.setter(
          #state,
          value,
        ),
  ...
  @override
  void changeState(_i6.CartState? value) => super.noSuchMethod(
        Invocation.method(
          #changeState,
          [value],
        ),
  ...
  @override
  _i11.Future<void> createOrder(_i12.BuildContext? context) =>
      (super.noSuchMethod(
        Invocation.method(
          #createOrder,
          [context],
  ...
  @override
  void resetRestaurantName() => super.noSuchMethod(
        Invocation.method(
          #resetRestaurantName,
          [],
        ),
