...
//   ProductModel testMock = const ProductModel(
//     id: '0',
//     name: 'name',
...
//     when(usecase.call(RestaurantEnum.souza_de_abreu))
...
//       modular.Bind<UserController>((i) => userController),
//     ]);
//   });
...
//           .changeState(UserMenuLoadedSuccessState(index: 2, listProduct: [])));
//       await widgetTester.pump();
